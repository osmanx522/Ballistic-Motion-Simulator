            ...
            if self.use_friction:
                ...
                while y >= 0:
                    ...
                    if v_total > 0:
                        ...
                        f_drag = 0.5 * rho * (v_total**2) * self.cd * self.area
                        
                        # 3. İvme (a = F / m)
                        a_drag = f_drag / self.mass
                    ...
                    if y_new < 0:
                        ...
                        y_new = 0.0
                        t_new = t + dt_fraction
                        t_list.append(t_new); x_list.append(x_new); y_list.append(y_new)
                        break
